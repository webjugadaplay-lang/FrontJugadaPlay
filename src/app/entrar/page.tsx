...
// Importar jsQR dinámicamente solo en el cliente
let jsQR: any;
...
export default function EntrarSala() {
  ...
  // Renderizado del formulario (siempre visible)
  const renderForm = () => (
    <>
    ...
    <main className="min-h-screen bg-black">
      ...
      <div className="pt-32 pb-20 px-6 min-h-screen flex items-center justify-center">
        <div className="max-w-md w-full mx-auto">
          ...
          <Link href="/" className="mt-8 flex items-center justify-center gap-2 text-gray-600 text-sm hover:text-yellow-500 transition-colors group">
